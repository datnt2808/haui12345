...
BEGIN
  SELECT tb.OrderID,
         ...
         tb.CreatedBy,
         tb.ModifiedDate,
         tb.ModifiedBy FROM tb_orders tb WHERE tb.OrderID = v_OrderID;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Proc_Orders_Insert`(IN v_OrderID int, v_OrderCode varchar(100), IN v_OrderDate datetime, IN v_IdUser int, IN v_FullName varchar(255), IN v_Address varchar(255), IN v_PhoneNumber varchar(255),IN v_Description varchar(255),IN v_TotalAmount int, IN v_StatusOrders int, IN v_StatusOrdersName varchar(255), IN v_CheckOutTypeID int, IN v_CheckOutTypeName varchar(255), IN v_CheckOutStatusID int, IN v_CheckOutStatusName varchar(100),IN v_Reason varchar(255), IN v_CreatedDate datetime, IN v_CreatedBy varchar(100), IN v_ModifiedDate datetime, IN v_ModifiedBy varchar(100))
BEGIN
  INSERT INTO tb_orders (OrderID, ordercode, orderdate, IdUser, FullName, address, phonenumber,Description, totalAmount, StatusOrders, StatusOrdersName, checkouttypeid, checkouttypename, checkoutstatusid, checkoutstatusname,Reason, createddate, createdby, modifieddate, modifiedby)
    VALUES (v_OrderID, v_OrderCode, v_OrderDate, v_IdUser, v_FullName, v_Address, v_PhoneNumber,v_Description,v_TotalAmount, v_StatusOrders, v_StatusOrdersName, v_CheckOutTypeID, v_CheckOutTypeName, v_CheckOutStatusID, v_CheckOutStatusName,v_Reason, v_CreatedDate, v_CreatedBy, v_ModifiedDate, v_ModifiedBy);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Proc_Orders_UpdateStatus` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb3 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Proc_Orders_UpdateStatus`(IN v_IdOrder int, IN v_Status int,IN v_Reason varchar(255))
BEGIN
  UPDATE tb_orders
  SET OrderID = v_IdOrder,
      StatusOrders = v_Status,
      Reason = v_Reason
  WHERE OrderID = v_IdOrder;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Proc_UpdateOrderDetailCommentProduct` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb3 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Proc_UpdateOrderDetailCommentProduct`(IN v_IdOrder int, IN v_IdOrderDetail int, IN v_IdProduct int)
BEGIN
  UPDATE tb_orderdetail
  SET OrderDetailID = v_IdOrderDetail,
      OrderID = v_IdOrder,
      ProductID = v_IdProduct,
      IsComment = 1
  WHERE OrderDetailID = v_IdOrderDetail;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
  SELECT SUM(tbo.totalAmount) FROM tb_orders tbo WHERE tbo.StatusOrders = 1;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
